...
export const translations: Record<UiLang, Record<string, string>> = {
  zh: {
    ...
    "entry.copyTooltip": "复制 session_id",
    "entry.openTitle": "打开已有 workspace",
    "entry.openButton": "打开",
    "entry.openErrorEmpty": "请输入 session_id",
    "entry.openErrorFailed": "打开失败，请确认 session_id 是否正确",
    "entry.or": "或",
    "entry.createTitle": "新建 workspace",
    "entry.modeLabel": "模式",
    "entry.modeEnv": "Default Provider",
    "entry.modeByok": "BYOK (Bring Your Own Key)",
    "entry.show": "显示",
    "entry.hide": "隐藏",
    "entry.promptSetLabel": "Prompt 集",
    ...
    "sidebar.empty": "暂无记录",
    "sidebar.deleteSession": "删除 session",
    "sidebar.githubTooltip": "GitHub 仓库",
    "sidebar.confirmTitle": "删除 session",
    "sidebar.confirmMessage": "确认删除 session {id}？此操作不可撤销。",
    ...
    // WorkspaceEditor
    "editor.title": "编辑 workspace 文件",
    "editor.download": "下载",
    "editor.alert": "修改会自动保存（停止输入约 {ms}ms 后触发）。保存后 agent 自动重载；workspace 编码状态保留。",
    ...
    // App
    "app.deleteFailed": "删除 session 失败",
  ...
  en: {
    ...
    "entry.show": "Show",
    "entry.hide": "Hide",
    "entry.promptSetLabel": "Prompt set",
    ...
    "editor.alert": "Changes auto-save about {ms}ms after you stop typing. After saving, the agent reloads automatically; workspace coding state is preserved.",
